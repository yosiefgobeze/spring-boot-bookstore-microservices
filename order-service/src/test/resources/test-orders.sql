...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'order-123', 'minas', 'lamiek', 'lamiek@gmail.com', '5105621256', '2056 Eagle Street', 'Apt 1', 'Dallas', 'TX', '56231', 'USA', 'NEW', null),
                                         (2, 'order-456', 'minas', 'minas', 'minas@gmail.com', '4254561236', '451 BuenoVista Ave', 'Apt 1', 'Alameda', 'CA', '94555', 'USA', 'NEW', null)
;
