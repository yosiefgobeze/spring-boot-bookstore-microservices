...
import static com.samsun.bookstore.orders.testdata.TestDataFactory.createOrderRequestWithInvalidCustomer;
import static com.samsun.bookstore.orders.testdata.TestDataFactory.createOrderRequestWithInvalidDeliveryAddress;
import static com.samsun.bookstore.orders.testdata.TestDataFactory.createOrderRequestWithNoItems;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        given(securityService.getLoginUserName()).willReturn("yosief");
    }
    ...
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        ...
        given(orderService.createOrder(eq("yosief"), any(CreateOrderRequest.class)))
                .willReturn(null);
