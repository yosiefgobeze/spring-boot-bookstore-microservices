package com.samsun.bookstore.orders.testdata;

import static org.instancio.Select.field;

import com.samsun.bookstore.orders.domain.models.Address;
import com.samsun.bookstore.orders.domain.models.CreateOrderRequest;
import com.samsun.bookstore.orders.domain.models.Customer;
import com.samsun.bookstore.orders.domain.models.OrderItem;
...
public class TestDataFactory {
    static final List<String> VALID_COUNTIES = List.of("USA", "California");
    static final Set<OrderItem> VALID_ORDER_ITEMS =
            Set.of(new OrderItem("P140", "Product 1", new BigDecimal("25.50"), 1));
